...
class LoginActivityChat : Activity(), LoginListener, AnkoLogger {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        login.setOnClickListener {
            ...
            TwilioApplication.instance.basicClient.login(userName, certPinningChosen, realm, url, this@LoginActivityChat)
        }
