...
class DeleteMessage extends AsyncTask<String,String,String> {
    ...
    protected String doInBackground(String... params) {
        try {
            url = new URL(Global.HostName+"messages/index/delete_message_json");
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("messageId", params[2]);
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            errorStatus=object.getBoolean("errorStatus");
            errorMessage=object.getString("errorMessage");
            if (errorStatus.equals(true)){
                Toast.makeText(context,errorMessage,Toast.LENGTH_LONG).show();
            }
            else {
                Toast.makeText(context,object.getString("sussessMessage"),Toast.LENGTH_LONG).show();
            }
