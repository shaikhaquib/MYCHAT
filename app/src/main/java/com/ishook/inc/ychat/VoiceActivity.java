...
public class VoiceActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = Global.HostName+"ishook_voice_call/andr/accessToken.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  sid = sharedPreferences.getString(Constants.KEY_SESSION, "N/A");
       // identity = sharedPreferences.getString(Constants.KEY_USERID, "N/A");
        freindid = getIntent().getStringExtra("FriendId");
        ...
        try {
            ...
            identity=object.getString("UserName");
...
*/
    ...
    public static AlertDialog createCallDialog(final DialogInterface.OnClickListener callClickListener,
        ...
        final TextView Text =  dialogView.findViewById(R.id.cmText);
        Text.setText("Do you want to call your friend "+freindname);
        contact.setText(freindname.replaceAll(" ","").toLowerCase());
