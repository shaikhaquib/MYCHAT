...
class AlbumLike extends AsyncTask<String,String,String> {
    ...
    protected String doInBackground(String... params) {
        try {
            url = new URL(Global.HostName+"albums/album_web_service/do_like_unlike_media_json");
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("MediaId", params[2]);
