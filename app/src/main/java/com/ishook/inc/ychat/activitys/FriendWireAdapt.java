...
import com.ishook.inc.ychat.adapters.AsyncLike;
import com.ishook.inc.ychat.adapters.DeleteWire;
import com.ishook.inc.ychat.adapters.ReportAbuse;
...
/**
 * Created by Shaikh on 25-01-2018.
 */

class FriendWireAdapt extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FriendWireAdapt(Context context, final List<Wire_list> data) throws JSONException {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof VHHeader)
        {
            ...
            final Wire_list current = mData.get(position);
...
*/
            ...
            {
                myViewHolder.multiple_image_sign.setVisibility(View.GONE);
            }
